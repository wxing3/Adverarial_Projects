function [t,x_new,f_new,g_new,funEvals,nUnconverge,H] = ArmijoBacktrack(...
    x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,saveHessianComp,funObj,nUnconverge, unconvergeLimit, varargin)
