function [t,f_new,g_new,funEvals,nUnconverge,H] = WolfeLineSearch(...
    x,t,d,f,g,gtd,c1,c2,LS_interp,LS_multi,maxLS,progTol,debug,doPlot,saveHessianComp,funObj,nUnconverge, unconvergeLimit, varargin)
%
...
if nargout == 6
    ...
    [f_new,g_new,unconvergeFlag] = funObj(x+t*d,varargin{:});
end
funEvals = 1;
gtd_new = g_new'*d;
...
while LSiter < maxLS
    ...
    if ~isLegal(f_new) || ~isLegal(g_new)
        ...
        % Do Armijo
        if nargout == 6
            [t,x_new,f_new,g_new,armijoFunEvals,nUnconverge,H] = ArmijoBacktrack(...
                x,t,d,f,f,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,saveHessianComp,...
                funObj,nUnconverge, unconvergeLimit, varargin{:});
        else
            [t,x_new,f_new,g_new,armijoFunEvals,nUnconverge] = ArmijoBacktrack(...
                x,t,d,f,f,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,saveHessianComp,...
                funObj,nUnconverge, unconvergeLimit, varargin{:});
        end
